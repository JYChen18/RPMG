...
class Ordered_EasyDict(object):
    ...
    def __repr__(self,
                 _repr_running={}):  # [Adapted from]  https://github.com/python/cpython/blob/2.7/Lib/collections.py
...
def test_case2():
    tpls = [('label', [1, 1]), ('e1', [1, 1]), ('e2', [1, 1]), ('e3', [1, 1]), ('e1coarse', [1, 1]),
            ('e2coarse', [1, 1]), ('e3coarse', [1, 1]), ('data', [1, 3, 227, 227])]
    # tpls = odict(tpls)
