...
proj_info = [
    ...
    ('cad_id', (str, MAX_STRING_LEN)),  # <primary key>
...
pose_hypo = [
    ('pose_hypo_id', (str, MAX_STRING_LEN)),
    # <primary key>   format:   pose_id = {obj_id}_{a},{e},{t}     e.g. 2008_000251-24,14,410,245_144,0,2
    ('pose_gt_id', (str, MAX_STRING_LEN)),  # point to gt inside this table (for convenience)
    ('obj_id', (str, MAX_STRING_LEN)),  # <foreign key>
