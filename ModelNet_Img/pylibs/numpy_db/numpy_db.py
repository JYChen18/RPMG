...
def test_table_db1():
    ...
    anno_file = os.path.join(data_dir,
                             'cache/binnedJoint_%s_no_augment-with_proj_param.flat_obj_list.aeroplane-%02d.pkl' % (
                             collection, cad_type))
...
if __name__ == "__main__":
    ...
    collection, cad_type = "Val", 1
    data_dir = env.HOME + '/working/cvpr17pose/code/mycode/Subcnn.surgery/Voxelproj_RC_net/data'
    anno_file = os.path.join(data_dir, 'cache/binnedJoint_%s_no_augment-with_proj_param.aeroplane-%02d.pkl' % (
    collection, cad_type))
